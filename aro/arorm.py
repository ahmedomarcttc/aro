...
import json
import logging
from emuvim.dcemulator.resourcemodel import ResourceFlavor, BaseResourceModel, NotEnoughResourcesAvailable

LOG = logging.getLogger("aro.api.arorm")
LOG.setLevel(logging.DEBUG)

CPU_PERIOD = 1000000


class ARORM(BaseResourceModel):
    """
